...
ActiveRecord::Schema.define(version: 2019_08_08_183701) do
  ...
  create_table "user_vehicles", force: :cascade do |t|
    ...
    t.index ["user_id", "vehicle_id"], name: "index_user_vehicles_on_user_id_and_vehicle_id", unique: true
  ...
  create_table "vehicles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.decimal "fuel_efficiency", precision: 15, scale: 10
